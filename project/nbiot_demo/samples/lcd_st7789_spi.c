 ...
 * 2019-08-05    balanceTWK         Add a option to set landscape or portrait display
 */
...
#define LCD_DC_PIN            (NB_PIN_34)
#define LCD_RES_PIN           (NB_PIN_35)
#define LCD_CS_PIN            (NB_PIN_3)
#define LCD_CS_PIN_FUN        (2u)       /* HAL_GPIO_8_SPI_MST0_CS */
...
{
    spi_dev_lcd = (struct rt_spi_device *)rt_device_find("spi00");
    ...
    /* config spi */
    {
        ...
        cfg.max_hz = 52 * 1000 * 1000; /* 42M,SPI max 42MHz,lcd 4-wire spi */
...
{
    rt_hw_spi_device_attach("spi0", "spi00", LCD_CS_PIN, LCD_CS_PIN_FUN);
    lcd_gpio_init();
...
void lcd_address_set(rt_uint16_t x1, rt_uint16_t y1, rt_uint16_t x2, rt_uint16_t y2)
{
    ...
    {
        lcd_write_cmd(0x2a);
        lcd_write_half_word(x1 + 52);
        lcd_write_half_word(x2 + 52);
        lcd_write_cmd(0x2b);
        lcd_write_half_word(y1 + 40);
        lcd_write_half_word(y2 + 40);
        lcd_write_cmd(0x2c);
    }
    else if (USE_HORIZONTAL == 1)
    {
        lcd_write_cmd(0x2a);
        lcd_write_half_word(x1 + 53);
        lcd_write_half_word(x2 + 53);
        lcd_write_cmd(0x2b);
        lcd_write_half_word(y1 + 40);
        lcd_write_half_word(y2 + 40);
        lcd_write_cmd(0x2c);
    ...
    {
        lcd_write_cmd(0x2a);
        lcd_write_half_word(x1 + 40);
        lcd_write_half_word(x2 + 40);
        lcd_write_cmd(0x2b);
        lcd_write_half_word(y1 + 53);
        lcd_write_half_word(y2 + 53);
        lcd_write_cmd(0x2c);
    }
    else
    {
        ...
        lcd_write_half_word(x2 + 40);
        lcd_write_cmd(0x2b);
        lcd_write_half_word(y1 + 52);
        lcd_write_half_word(y2 + 52);
        lcd_write_cmd(0x2c);
    }
}
